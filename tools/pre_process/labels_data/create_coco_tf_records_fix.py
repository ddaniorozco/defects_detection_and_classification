...
if __name__ == '__main__':
    ...
    # FLAGS.train_image_dir = 's3://hawkeye-tfrecord/daniel/automation_test/train_images'
    # FLAGS.val_image_dir = 's3://hawkeye-tfrecord/daniel/automation_test/test_images'
    # FLAGS.test_image_dir = 's3://hawkeye-tfrecord/daniel/automation_test/test_images'
    # FLAGS.train_annotations_file = 's3://hawkeye-tfrecord/daniel/automation_test/coco_data/train.json'
    # FLAGS.val_annotations_file = 's3://hawkeye-tfrecord/daniel/automation_test/coco_data/test.json'
    # FLAGS.testdev_annotations_file = 's3://hawkeye-tfrecord/daniel/automation_test/coco_data/test.json'

    tf.app.run()


# --train_image_dir=s3://hawkeye-tfrecord/daniel/automation_test/train_images \
# --val_image_dir=s3://hawkeye-tfrecord/daniel/automation_test/test_images \
# --test_image_dir=s3://hawkeye-tfrecord/daniel/automation_test/test_images \
# --train_annotations_file=s3://hawkeye-tfrecord/daniel/automation_test/coco_data/train.json \
# --val_annotations_file=s3://hawkeye-tfrecord/daniel/automation_test/coco_data/test.json \
# --testdev_annotations_file=s3://hawkeye-tfrecord/daniel/automation_test/coco_data/test.json \
# --output_dir=/Users/daniorozco/Desktop/automation_test/data_automation/tf_records/